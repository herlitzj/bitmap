// Creates the dropCtrl Module and Controller. Note that 
//it depends on the 'geolocation' module and service.
var browseCtrl = angular.module('browseCtrl', ['geolocation', 'gservice']);
browseCtrl.controller('browseCtrl', function($scope, $http, 
                        $rootScope, geolocation, gservice){
